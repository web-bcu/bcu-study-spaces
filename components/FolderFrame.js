...
export default function FolderFrame({folderId, folderName}) {
    ...
    return (
        <div className='w-full flex items-center hover:bg-cyan-500 hover:bg-opacity-40 text-white justify-start px-8 py-2 rounded-md border-b border-cyan-500'>
            <button className='flex gap-5 items-center w-5/6' onClick={() => router.push(`/dashboard/document/${folderId}`)} disabled={edit}>
